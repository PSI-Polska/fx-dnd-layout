...
public class EFXDragEvent extends Event
{
     ...
     */
    public static final EventType< EFXDragEvent > ANY = new EventType< EFXDragEvent >( Event.ANY, "DRAG" );
    //$NON-NLS-1$
     ...
     */
    public static EventType< EFXDragEvent > DRAG_OVER = new EventType<>( EFXDragEvent.ANY, "DRAG_OVER" );
    //$NON-NLS-1$

    /**
     * Event fired when dropped
     */
    public static final EventType< EFXDragEvent > DRAG_DROPPED =
        new EventType< EFXDragEvent >( EFXDragEvent.ANY, "DRAG_DROPPED" ); //$NON-NLS-1$

    /**
     * Event fired when drag exits the area
     */
    public static final EventType< EFXDragEvent > DRAG_EXITED =
        new EventType< EFXDragEvent >( EFXDragEvent.ANY, "DRAG_EXITED" ); //$NON-NLS-1$

    /**
     * Event fired when drag is done
     */
    public static final EventType< EFXDragEvent > DRAG_DONE =
        new EventType< EFXDragEvent >( EFXDragEvent.ANY, "DRAG_DONE" ); //$NON-NLS-1$
    ...
    static class DragFeedbackStage extends DragFeedback
    {
        ...
        public DragFeedbackStage( Node n )
        {
            ...
            this.popupWindow.setUserData( Util.FIND_NODE_EXCLUDE ); //$NON-NLS-1$
     ...
     */
    public EFXDragEvent( Object source, EventTarget target, EventType< ? extends Event > eventType,
        double screenX, double screenY, boolean complete )
    {
