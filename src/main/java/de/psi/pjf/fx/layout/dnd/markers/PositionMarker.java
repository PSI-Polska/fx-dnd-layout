...
public final class PositionMarker extends Group
{
    ...
    private final ObjectProperty< Paint > fill =
        new SimpleStyleableObjectProperty<>( FILL, this, "fill", Color.rgb( 0, 139, 255 ) ); //$NON-NLS-1$
    ...
    private static final CssMetaData< PositionMarker, Paint > FILL =
        new CssMetaData< PositionMarker, Paint >( "-fx-fill", StyleConverter.getPaintConverter(),
            Color.rgb( 0, 139, 255 ) )
        { //$NON-NLS-1$
